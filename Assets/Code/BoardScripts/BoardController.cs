...
public class BoardController : MonoBehaviour
{
    ...
    private void CheckRows(bool _player){
        ...
        // Middle row
        if(tileControllers[4].thisSprite.sprite.name != ""){
        ...
        // Bottom row
        if(tileControllers[7].thisSprite.sprite.name != ""){
    ...
    private void CheckColumns(bool _player){
        // Left column
        if(tileControllers[3].thisSprite.sprite.name != ""){
        ...
        // Right column
        if(tileControllers[5].thisSprite.sprite.name != ""){
